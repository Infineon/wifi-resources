...
ifeq ($(filter 89530,$(DEVICE_COMPONENTS)),89530)
    ifeq ($(filter WLAN_MFG_FIRMWARE,$(DEFINES)),WLAN_MFG_FIRMWARE)
        ifeq ($(filter CYW989530SDCM2WLIPA,$(DEVICE_COMPONENTS))$(filter CYW989530SDCM2WLIPA,$(BSP_COMPONENTS)),CYW989530SDCM2WLIPA)
                CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI6/COMPONENT_89530/COMPONENT_CYW989530SDCM2WLIPA/89530A0-mfgtest.clm_blob"
        else ifeq ($(filter CYW989530WLIPAREV1_01,$(DEVICE_COMPONENTS))$(filter CYW989530WLIPAREV1_01,$(BSP_COMPONENTS)),CYW989530WLIPAREV1_01)
        ...
        ifeq ($(filter CYW989530SDCM2WLIPA,$(DEVICE_COMPONENTS))$(filter CYW989530SDCM2WLIPA,$(BSP_COMPONENTS)),CYW989530SDCM2WLIPA)
                CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI6/COMPONENT_89530/COMPONENT_CYW989530SDCM2WLIPA/89530A0.clm_blob"
        else ifeq ($(filter CYW989530WLIPAREV1_01,$(DEVICE_COMPONENTS))$(filter CYW989530WLIPAREV1_01,$(BSP_COMPONENTS)),CYW989530WLIPAREV1_01)
    ...
    ifeq ($(filter CYW989530SDCM2WLIPA,$(DEVICE_COMPONENTS))$(filter CYW989530SDCM2WLIPA,$(BSP_COMPONENTS)),CYW989530SDCM2WLIPA)
            NVRAM_FILE_PATH_NAME := "$(wildcard $(NVRAM_PATH)/COMPONENT_WIFI6/COMPONENT_89530/COMPONENT_CYW989530SDCM2WLIPA/*.txt)"
    else ifeq ($(filter CYW989530WLIPAREV1_01,$(DEVICE_COMPONENTS))$(filter CYW989530WLIPAREV1_01,$(BSP_COMPONENTS)),CYW989530WLIPAREV1_01)
	...
	ifeq ($(filter WLAN_MFG_FIRMWARE,$(DEFINES)),WLAN_MFG_FIRMWARE)
		...
		ifeq ($(filter CYW955513SDM2WLIPA,$(DEVICE_COMPONENTS))$(filter CYW955513SDM2WLIPA,$(BSP_COMPONENTS)),CYW955513SDM2WLIPA)
			...
			CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI6/COMPONENT_55500/COMPONENT_CYW55513_MOD_PSE84_SOM/55500A1.clm_blob"
		else ifeq ($(filter MURATA-2FY,$(DEVICE_COMPONENTS))$(filter MURATA-2FY,$(BSP_COMPONENTS)),MURATA-2FY)
    ...
    ifeq ($(filter WLAN_MFG_FIRMWARE,$(DEFINES)),WLAN_MFG_FIRMWARE)
	    ...
	    else ifeq ($(filter MURATA-2GF,$(DEVICE_COMPONENTS))$(filter MURATA-2GF,$(BSP_COMPONENTS)),MURATA-2GF)
                    CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI5/COMPONENT_43022/COMPONENT_MURATA-2GF/43022C1-mfgtest.clm_blob"
	    endif
    else
	    ifeq ($(filter CYW43022CUB,$(DEVICE_COMPONENTS))$(filter CYW43022CUB,$(BSP_COMPONENTS)),CYW43022CUB)
                    ...
                    CLM_FILE_PATH_NAME := "$(CLM_PATH)/COMPONENT_WIFI5/COMPONENT_43022/COMPONENT_MURATA-2GF/43022C1.clm_blob"
	    endif
    endif
	ifeq ($(filter CYW43022CUB,$(DEVICE_COMPONENTS))$(filter CYW43022CUB,$(BSP_COMPONENTS)),CYW43022CUB)
                ...
                NVRAM_FILE_PATH_NAME := "$(wildcard $(NVRAM_PATH)/COMPONENT_WIFI5/COMPONENT_43022/COMPONENT_MURATA-2GF/*.txt)"
	endif
...
DEFINES+= NVRAM_IMAGE_SIZE=$(NVRAM_FILE_SIZE) CLM_IMAGE_SIZE=$(CLM_FILE_SIZE) 
DEFINES+= NVRAM_IMAGE_NAME='$(NVRAM_FILE_PATH_NAME)' CLM_IMAGE_NAME='$(CLM_FILE_PATH_NAME)' 
